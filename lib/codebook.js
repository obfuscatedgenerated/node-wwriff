...
Codebook.prototype.rebuild = function(id, outstream) {
    var codebook = this.get_codebook(id);
    this._rebuild(codebook, outstream)
}

Codebook.prototype._rebuild = function(buf, os) {
    ...
    os.writeBits(new Buffer([ 0x42, 0x43, 0x56 ]), 24);
